...
export default function BusinessesNavBar() {
  ...
  const links = [
    { name: "Dashboard", href: "/businesses/dashboard", icon: "fas fa-gauge" },
    { name: "Reports", href: "/businesses/reports", icon: "fas fa-clipboard-list" },
    { name: "Waste Log", href: "/businesses/wastelog", icon: "fas fa-recycle" },
    { name: "Challenges", href: "/businesses/challenges", icon: "fas fa-trophy" },
    { name: "Community", href: "/businesses/community", icon: "fas fa-people-group" },
    { name: "Profile", href: "/businesses/profile", icon: "fas fa-user-circle" },
  ];
  ...
  const renderUserSection = () => (
    <div style={{ padding: "20px", position: "relative" }}>
      ...
      >
        ...
        <div>
          <div style={{ fontWeight: "bold", fontSize: "14px" }}>Business</div>
