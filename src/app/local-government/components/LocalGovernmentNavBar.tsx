...
export default function LocalGovernmentNavBar() {
  ...
  const links = [
    ...
    { name: "Profile", href: "/local-government/profile", icon: "fas fa-user-circle" },
  ];
  ...
  const renderUserSection = () => (
    <div style={{ padding: "20px", position: "relative" }}>
      ...
      >
        ...
        <div>
          <div style={{ fontWeight: "bold", fontSize: "14px" }}>LGU</div>
