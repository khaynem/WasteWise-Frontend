...
export default function NonGovernmentNavBar() {
  ...
  const links = [
    { name: "Dashboard", href: "/non-government/dashboard", icon: "fas fa-gauge" },
    { name: "Reports", href: "/non-government/reports", icon: "fas fa-clipboard-list" },
    { name: "Challenges", href: "/non-government/challenges", icon: "fas fa-trophy" },
    { name: "Community", href: "/non-government/community", icon: "fas fa-people-group" },
    { name: "Profile", href: "/non-government/profile", icon: "fas fa-user-circle" },
  ];
  ...
  const renderUserSection = () => (
    <div style={{ padding: "20px", position: "relative" }}>
      ...
      >
        ...
        <div>
          <div style={{ fontWeight: "bold", fontSize: "14px" }}>NGO</div>
